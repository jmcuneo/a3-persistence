...
const submit = async function (event) {
  ...
  if (isEmpty(itemInput.value) || isEmpty(qtyInput.value)) {
    alert("Please fill out all fields. If the price is unknown, you may leave it blank.");
    return;}
  const newEntry = createEntry(itemInput.value, priceInput.value, qtyInput.value);
...
const suggest = async function (event) {
  ...
  if (isEmpty(itemSuggest.value) || isEmpty(qtySuggest.value) ) {
    alert("Please fill out all fields. If the quantity is unknown, you may leave it blank.");
    return;}
